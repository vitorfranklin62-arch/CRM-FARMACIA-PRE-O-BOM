...
/**
 * Favicon/ícone de app gerado dinamicamente (heart + pill), reproduzindo o
 * ícone oficial da marca em SVG-para-PNG — evita depender de um arquivo
 * binário pré-pronto. Troque por `favicon-512.png` real quando disponível.
 */
export async function GET() {
  return new ImageResponse(
    (
      ...
      >
        <svg viewBox="0 0 120 120" width="384" height="384">
          <path
            fill="#FE0000"
